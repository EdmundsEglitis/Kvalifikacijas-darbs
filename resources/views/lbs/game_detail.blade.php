...
<body class="bg-gray-100">
    ...
    <header class="bg-white shadow-md fixed w-full top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex justify-between items-center">
            ...
            <h1 class="text-xl font-bold text-gray-800">{{ $game->team1->name }} vs {{ $game->team2->name }}</h1>
        </div>
    </header>
    ...
    <main class="pt-32 max-w-6xl mx-auto px-4 space-y-6">
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <p class="text-gray-600 mb-2">Date: {{ $game->date }}</p>
            ...
            @if($game->team1_q1 !== null)
                <div class="grid grid-cols-2 gap-4 mb-6">
                    <div class="bg-gray-100 p-3 rounded">
                        <h3 class="font-semibold mb-2">{{ $game->team1->name }} Quarter Scores</h3>
                    ...
                    <div class="bg-gray-100 p-3 rounded">
                        <h3 class="font-semibold mb-2">{{ $game->team2->name }} Quarter Scores</h3>
            ...
            <div class="grid grid-cols-2 gap-6">
                @foreach([$game->team1_id, $game->team2_id] as $teamId)
                    ...
                    <div class="bg-white shadow rounded-lg p-4">
                        <h2 class="text-xl font-bold mb-2">{{ $team->name }} Player Stats</h2>
